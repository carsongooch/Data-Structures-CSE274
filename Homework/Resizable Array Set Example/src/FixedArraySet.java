...
/**
 * A resizeable-array-based implementation 
...
public class FixedArraySet {
	...
	public boolean add(String s) {
		...
		// PUT THIS RESIZING LOGIC IN A HELPER METHOD FOR YOUR HOME
		// check if array is full, and if so,
		// replace it with a new array twice the length
		// This is a one line version of the code below
		// this.data = Arrays.copyOf(this.data, data.length * 2);
		if (this.size == data.length) {
			// New array twice the length
